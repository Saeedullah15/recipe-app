                ...
                <div className="flex flex-wrap items-center justify-between py-3 gap-6 md:py-4 md:gap-0">
                    ...
                    <div className="hidden peer-checked:flex w-full flex-col lg:flex lg:flex-row justify-end z-30 items-center gap-y-6 p-6 rounded-xl bg-white  lg:gap-y-0 lg:p-0 md:flex-nowrap lg:bg-transparent lg:w-7/12">
                        ...
                        {/* sign up, login, log out */}
                        {
                            user ?
                                (
                                    <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 justify-between items-center w-full lg:border-l border-yellow-200 pl-8">
                                        <p className="font-semibold underline">Welcome, {user.name}!</p>

                                        <button onClick={handleLogout} className="w-full py-3 px-6 text-center rounded-full transition bg-yellow-300 hover:bg-yellow-100 active:bg-yellow-400 focus:bg-yellow-300 sm:w-max"
                                        >
